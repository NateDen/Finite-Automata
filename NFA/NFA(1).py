...
def main():
    ...
    q6.addTransition("a", 8)
    
    q7.addTransition("epsilon", 1)    
    
    q8.addTransition("a", 10)   
    
    q10.addTransition("a", 2)    
    
    
    nfa = NFAStateMachine({0:q0, 1:q1, 2:q2, 3:q3, 4:q4, 5:q5, 6:q6, 7:q7, 8:q8, 9:q9, 10:q10}, 0, classes)
